...
import {DocumentEditor, LabelEditor, ParagraphEditor} from "./documentUtils.js";
...
const labelEditor: LabelEditor = new LabelEditor(document, QUIZ_QUESTION_ANSWER_LABEL_ID);
labelEditor.setInnerHTML("XD");
